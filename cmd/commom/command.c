...
#define CMD_VERSION	"CMD Version 1.3.0";
const char version_string[] =	CMD_VERSION;
...
#ifdef  CFG_LONGHELP
cmd_tbl_t __diag_cmd_question_mark Struct_Section = {
...
{
	cmd_tbl_t *cmdtp;
	cmd_tbl_t *cmdtp_temp = __diag_cmd_start;	/*Init value */
	const char *p;
	int len;
	int n_found = 0;
	...
	for (cmdtp = (__diag_cmd_start);
	     cmdtp != (__diag_cmd_end);
	     cmdtp++) {
