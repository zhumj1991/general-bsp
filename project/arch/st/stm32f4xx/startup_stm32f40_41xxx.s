...
; __driver_start address
; __driver_end address
				IMPORT	||Image$$ER_DRIVER$$Base||
				IMPORT	||Image$$ER_DRIVER$$Limit||
__init_driver_start
				DCD		||Image$$ER_DRIVER$$Base||

__init_driver_end
				DCD		||Image$$ER_DRIVER$$Limit||
				EXPORT  __init_driver_start
				EXPORT  __init_driver_end
					
; __diag_cmd_start address
; __diag_cmd_end address
				IMPORT	||Image$$ER_CMD$$Base||
				IMPORT	||Image$$ER_CMD$$Limit||
__diag_cmd_start
				DCD		||Image$$ER_CMD$$Base||

__diag_cmd_end
				DCD		||Image$$ER_CMD$$Limit||
				EXPORT  __diag_cmd_start
				EXPORT  __diag_cmd_end
